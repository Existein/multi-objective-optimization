...
# Lambda Function URL
LAMBDA_FUNCTION_URL = "https://m57od5fvhnhok23s4dozma3uqm0xqlyw.lambda-url.us-east-1.on.aws/"
...
def run_benchmark():
    log_group = "/aws/lambda/mem_intensive_benchmark"  # 로그 그룹 설정
    
    # Lambda 함수 실행만 진행
    for memory in config_list:
        update_lambda_memory("mem_intensive_benchmark", memory)  # 메모리 크기 변경 
